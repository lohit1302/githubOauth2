...
public class TokenProvider {
    ...
    public String createToken(Authentication authentication) {
        com.github.demo.security.UserPrincipal userPrincipal = (UserPrincipal) authentication.getPrincipal();

        Date now = new Date();
        Date expiryDate = new Date(now.getTime() + applicationProperties.getAuth().getTokenExpirationMilliSec());
